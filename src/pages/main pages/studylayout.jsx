...
import { WidthAtom } from "../../atoms/atoms"
...
function Studylyout() {
    ...
    return <div className="flex flex-col">
        ...
        <div className="w-[900px] p-3 h-screen flex flex-col space-y-4">
            <iframe className="w-full h-[495px] border border-none rounded-3xl ml-9" src="https://www.youtube.com/embed/z5yvZW8Ep-E?si=7SvG7BW7OH2n54nE" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
