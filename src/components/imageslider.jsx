        ...
        id="image slider">
            ...
            <div className="flex mb-12 overflow-hidden " id="container">
                <div id="slider" ref={sliderRef} className="pl-[50%] pr-[50%] relative flex overflow-hidden snap-x snap-mandatory space-x-20 ">
                    <div ref={slidesref} className="snap-center lg:min-w-[1024px] md:min-w-[700px] sm:min-w-[500px] min-w-[300px] bg-blue-500 md:aspect-[1024/490] sm:aspect-[1024/690] aspect-[3/4] "><img className="w-full h-full brightness-125 contrast-125 saturate-125 object-cover "  src="src\assets\images\imagesforslider\image1.png" alt="" /></div>
                    <div className="snap-center lg:min-w-[1024px] md:min-w-[700px] sm:min-w-[500px] min-w-[300px] bg-blue-500 md:aspect-[1024/490] sm:aspect-[1024/690] aspect-[3/4] "><img className="w-full h-full brightness-125 contrast-125 saturate-125 object-cover "  src="src\assets\images\imagesforslider\image2.png" alt="" /></div>
                    <div className="snap-center lg:min-w-[1024px] md:min-w-[700px] sm:min-w-[500px] min-w-[300px] bg-blue-500 md:aspect-[1024/490] sm:aspect-[1024/690] aspect-[3/4]"><img className="w-full h-full brightness-125 contrast-125 saturate-125 object-cover "  src="src\assets\images\imagesforslider\image3.png" alt="" /></div>
                    <div className="snap-center lg:min-w-[1024px] md:min-w-[700px] sm:min-w-[500px] min-w-[300px] bg-blue-500 md:aspect-[1024/490] sm:aspect-[1024/690] aspect-[3/4]"><img className="w-full h-full brightness-125 contrast-125 saturate-125 object-cover "  src="src\assets\images\imagesforslider\image4.png" alt="" /></div>
                    <div className="snap-center lg:min-w-[1024px] md:min-w-[700px] sm:min-w-[500px] min-w-[300px] bg-blue-500 md:aspect-[1024/490] sm:aspect-[1024/690] aspect-[3/4]"><img className="w-full h-full brightness-125 contrast-125 saturate-125 object-cover "  src="src\assets\images\imagesforslider\image5.png" alt="" /></div>
                </div>
            </div>
