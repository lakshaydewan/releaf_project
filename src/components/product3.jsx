...
function Product3(){
    ...
    return <div id="main div" className="w-full flex justify-center">
        <div id="main content div" className="w-10/12 space-y-10">
            <div id="content div" className="w-full flex space-x-6 ">
                ...
                <div id="right section" className="max-w-5/12 w-5/12 space-y-10">
                    <div id="text" className="space-y-4">
                        <div id="heading" className="text-5xl font-semibold text-white">PRACTICAL FILE</div>
                        <div id="subheading" className="text-md font-light text-white">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Optio enim consequatur explicabo, hic quia odio ab quod vero harum expedita eligendi ut commodi recusandae nulla cum odit dolor itaque velit? </div>
                    </div>
