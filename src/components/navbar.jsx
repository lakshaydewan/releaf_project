        ...
        <div className="flex w-48 h-full items-center justify-center">
           {
            (user) ? (
                ...
                <div className="flex justify-center">
                    <button onClick={() => {
                        navigate("/mycart")
                    }} className="w-8 h-8 border border-none rounded-full bg-white flex justify-center items-center mr-3"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="size-4">
